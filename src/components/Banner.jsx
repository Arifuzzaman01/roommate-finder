  ...
  return (
    <div className=" py-10 flex flex-col md:flex-row gap-8 justify-end md:justify-between items-center ">
      ...
      <div className="relative">
        <div className="card bg-base-100 w-72 text-right md:w-96 shadow-sm border-white border-2">
          ...
          <div className="card-body">
            ...
            <p>
              A card component has a figure, Please visit our website and find
              out you like your favorite roommate. Before LogIn
            </p>
        ...
        {/* frontCard */}
        <div className="card bg-base-100 w-72 shadow-sm absolute top-18 -left-28 rotate-12 border-white border-2">
          <div className="flex gap-2">
            <img
