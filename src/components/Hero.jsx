...
const Hero = () => {
  ...
  return (
    <div className="md:flex flex-col hidden md:flex-row justify-between items-center gap-20 ">
      <div className="relative ">
        ...
        {/* frontCard */}
        <div className="card bg-base-100 w-72 shadow-sm absolute top-18 left-60 rotate-12 border-white border-2">
          <div className="flex gap-2">
            <img
      ...
      <div className="flex flex-col items-end -rotate-6">
        <h1 className="text-4xl md:text-5xl font-bold text-left ">
          Find your people. <br /> Find your place.
              ...
              <p className="max-w-2/3 border-t-2">Room Finder connects you to other verified renters in your area that are looking for roommates and posting available rooms that you can't find anywhere else. Stop stressing and let us help you find a better place to live!</p>
      </div>
    </div>
  );
};
