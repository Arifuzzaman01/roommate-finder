...
const CardSection = () => {
  return (
      <div className="py-10 ">
          <h1 className="text-center font-bold text-2xl underline py-7">Most Favorite Room Service</h1>
          <div className="md:grid md:grid-cols-3  gap-5">
              {/* card 1 */}
      <div className="card bg-white  shadow-md">
        <figure>
          <img className="w-full" src={singleBed} alt="Shoes" />
        </figure>
        <div className="card-body">
          <h2 className="card-title">Single Bed</h2>
          <p className="text-gray-600">
            Single Bed For one Person .Study environment with reading table and
            chair{" "}
          </p>
      ...
      <div className="card bg-white  shadow-md">
        <figure>
          <img className="w-full max-h-60" src={attachedBath1} alt="Shoes" />
        </figure>
        <div className="card-body">
          <h2 className="card-title">Double Bed Deluxe</h2>
          <p className="text-gray-600">
            Double deluxe Bed with attached Bath Room.Neat and clean with Study
            environment{" "}
          </p>
          <div className="card-actions justify-between">
            <div className="badge badge-outline">
      ...
      <div className="card bg-white  shadow-md">
        <figure>
          <img className="w-full max-h-60" src={studio1} alt="Shoes" />
        </figure>
        <div className="card-body">
      ...
      <div className="card bg-white  shadow-md">
        <figure>
          <img className="w-full max-h-60" src={double1} alt="Shoes" />
        </figure>
        <div className="card-body">
      ...
      <div className="card bg-white  shadow-md">
        <figure>
          <img className="w-full max-h-60" src={deluxe} alt="Shoes" />
        </figure>
        <div className="card-body">
      ...
      <div className="card bg-white  shadow-md">
        <figure>
          <img className="w-full max-h-60" src={studio2} alt="Shoes" />
        </figure>
        <div className="card-body">
